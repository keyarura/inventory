...
def get_columns():
	columns = [
		_("Date") + ":Datetime:150", _("Item") + ":Link/Item:130",
		_("Item Name") + "::100", _("Item Group") + ":Link/Item Group:100",
		_("Brand") + ":Link/Brand:70", _("Description") + "::200",
		_("Warehouse") + ":Link/Warehouse:120", _("Stock UOM") + ":Link/UOM:80",
		_("Qty") + ":Float:80", _("Balance Qty") + ":Float:80",
		_("Voucher Type") + "::110",
